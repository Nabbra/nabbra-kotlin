package com.example.project.presentation.view.screens.home.step1
...
import com.example.project.presentation.view.screens.home.DynamicDropdownMenu
...
class HomeScreenStep1 : Screen {
    @Composable
    override fun Content() {
        val navigator = LocalNavigator.currentOrThrow
        val items = listOf("Option 1", "Option 2", "Option 3", "Option 4") // Dynamic list of items
        ...
        Scaffold(
            ...
            content = { contentPadding ->
                Column(
                    ...
                    Button(
                        onClick = {
                            navigator.push(HomeScreenStep2())
                        },
